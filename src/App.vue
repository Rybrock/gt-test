...
<template>
  <div class="min-h-screen bg-gray-900 text-white w-full">
    <!-- Page Title -->
    <header class="text-center py-6 bg-dark text-accent flex justify-center items-center gap-x-2">
      <h1 class="text-3xl md:text-4xl font-bold">MGMaritime Vessel Status</h1>
